...
import {RequestApiListLesson , RequestApiListLessonDELETE , SortByCategory} from '../../app/actions/index'
                ...
                return (
                        <div key={index}
                            ...
                            <div className={classes.position_ab}>
                                {
                                    isHover.ishover === true && ele.id === isHover.id ? <div className={classes.after}>
